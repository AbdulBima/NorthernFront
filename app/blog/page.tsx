...
const Blog = () => {
	return (
		<>
			<div className="hidden md:flex relative h-[80vh] w-full items-center bg-[url('/images/elrufai.jpg')] bg-cover bg-center md:bg-center bg-no-repeat">
			...
			<div className='hidden md:flex'>
				...
				>
					<div className='w-full mx-auto z-20 mb-12 text-center md:w-2/3'>
						<p className='text-gray-700 -mt-16 headeMenus'>
							...
							>
								<a
									...
									className='text-yellow-600 hover:text-primary-dark'
								>
									<span
										itemProp='name'
										className='ml-2 mr-2'
						...
						<div className='flex ml-96 mt-6 headeMenus items-center mb-6 space-x-2'>
							<a
								href='#'
